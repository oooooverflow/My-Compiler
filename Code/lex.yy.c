...
static const flex_int16_t yy_accept[73] =
    {   0,
        0,    0,   34,   32,    2,    1,    3,   19,   32,   26,
       27,   14,   12,    9,   13,   18,   15,    4,    4,    8,
       11,   10,   11,   25,   28,   29,   25,   25,   25,   25,
       25,   25,   30,   32,   31,    2,   11,   16,    0,    0,
        0,    4,   25,   25,   25,   22,   25,   25,   25,   25,
       17,    0,    5,   25,   25,    7,   25,   25,   25,    0,
        6,   23,   25,   25,   25,   25,   25,   25,   24,   21,
       20,    0
    } ;
...
static const flex_int16_t yy_base[74] =
    {   0,
        0,    0,  109,  110,  106,  110,  110,   88,  100,  110,
      110,  110,  110,  110,  110,   27,  110,   31,   35,  110,
       86,   85,   84,    0,  110,  110,   71,   70,   17,   73,
       63,   69,  110,   57,  110,   94,  110,  110,   37,   39,
       47,   52,    0,   60,   61,    0,   57,   56,   57,   60,
      110,   59,   57,   62,   63,    0,   50,   49,   54,   41,
       61,    0,   47,   48,   55,   53,   46,   34,    0,    0,
        0,  110,   56
    } ;
...
static const flex_int16_t yy_def[74] =
    {   0,
       ...
       72,   72,   72,   73,   72,   72,   73,   73,   73,   73,
       73,   73,   72,   72,   72,   72,   72,   72,   72,   72,
       72,   72,   73,   73,   73,   73,   73,   73,   73,   73,
       72,   72,   72,   73,   73,   73,   73,   73,   73,   72,
...
static const flex_int16_t yy_nxt[152] =
    {   0,
       ...
       35,   39,   39,   40,   46,   41,   41,   40,   47,   42,
       42,   39,   39,   53,   53,   61,   61,   43,   52,   40,
       52,   41,   41,   52,   40,   52,   42,   42,   60,   71,
       60,   53,   53,   61,   61,   61,   61,   70,   52,   69,
       68,   67,   56,   52,   66,   65,   64,   63,   62,   59,
       58,   57,   56,   55,   54,   36,   51,   50,   49,   48,

       45,   44,   37,   37,   37,   38,   37,   36,   72,    3,
       72,   72,   72,   72,   72,   72,   72,   72,   72,   72,
       72,   72,   72,   72,   72,   72,   72,   72,   72,   72,
       72,   72,   72,   72,   72,   72,   72,   72,   72,   72,
       72,   72,   72,   72,   72,   72,   72,   72,   72,   72,
...
static const flex_int16_t yy_chk[152] =
    {   0,
       ...
       19,   39,   39,   40,   40,   60,   60,   73,   39,   41,
       40,   41,   41,   39,   42,   40,   42,   42,   52,   68,
       52,   53,   53,   52,   52,   61,   61,   67,   53,   66,
       65,   64,   63,   53,   59,   58,   57,   55,   54,   50,
       49,   48,   47,   45,   44,   36,   34,   32,   31,   30,

       28,   27,   23,   22,   21,    9,    8,    5,    3,   72,
       72,   72,   72,   72,   72,   72,   72,   72,   72,   72,
       72,   72,   72,   72,   72,   72,   72,   72,   72,   72,
       72,   72,   72,   72,   72,   72,   72,   72,   72,   72,
       72,   72,   72,   72,   72,   72,   72,   72,   72,   72,
...
YY_RULE_SETUP
#line 29 "./lexical.l"
{yylval = createNode(_INT, yylineno, 0); yylval->line = yylineno; yylval->value.intValue = atoi(yytext); return INT;}
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 30 "./lexical.l"
{yylval = createNode(_FLOAT, yylineno, 0); yylval->line = yylineno; yylval->value.floatValue = atof(yytext); return FLOAT;}
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 31 "./lexical.l"
{yylval = createNode(_FLOAT, yylineno, 0); yylval->line = yylineno;yylval->value.floatValue = mychange(yytext);return FLOAT;}
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 32 "./lexical.l"
{yylval = createNode(_TYPE, yylineno, 0); strcpy(yylval->name, yytext);yylval->line = yylineno; return TYPE;}
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 33 "./lexical.l"
...
YY_RULE_SETUP
#line 45 "./lexical.l"
{yylval = createNode(_STRUCT, yylineno, 0); yylval->line = yylineno; return STRUCT;}
	YY_BREAK
case 21:
YY_RULE_SETUP
#line 46 "./lexical.l"
{yylval = createNode(_RETURN, yylineno, 0); yylval->line = yylineno; return RETURN;}
	YY_BREAK
case 22:
YY_RULE_SETUP
#line 47 "./lexical.l"
{yylval = createNode(_IF, yylineno, 0); yylval->line = yylineno; return IF;}
	YY_BREAK
case 23:
YY_RULE_SETUP
#line 48 "./lexical.l"
{yylval = createNode(_ELSE, yylineno, 0); yylval->line = yylineno; return ELSE;}
	YY_BREAK
case 24:
YY_RULE_SETUP
#line 49 "./lexical.l"
{yylval = createNode(_WHILE, yylineno, 0); yylval->line = yylineno; return WHILE;}
	YY_BREAK
case 25:
YY_RULE_SETUP
#line 50 "./lexical.l"
{yylval = createNode(_ID, yylineno, 0); strcpy(yylval->name, yytext); yylval->line = yylineno; return ID;}
	YY_BREAK
case 26:
YY_RULE_SETUP
#line 51 "./lexical.l"
